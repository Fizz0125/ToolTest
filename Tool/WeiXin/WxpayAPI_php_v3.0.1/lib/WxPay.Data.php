...
class WxPayDataBase
{
	...
	/**
	 * [$wx_pay_sign_key description]
	 * @var string
	 */
	public $wx_pay_sign_key = '';
	...
	public function __construct (){
		...
		$this->wx_pay_sign_key = isset($wx_payment_info['wx_pay_sign_key']) ? $wx_payment_info['wx_pay_sign_key'] : '';
	}
	...
	**/
	...
	public function MakeSign()
	{
		...
		//签名步骤二：在string后加入KEY
		$string = $string . "&key=" . $this->wx_pay_sign_key;
		//签名步骤三：MD5加密
		$string = md5($string);
		//签名步骤四：所有字符转为大写
