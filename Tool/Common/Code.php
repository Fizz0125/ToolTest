...
class Code{
	...
	private $code;
	//验证码的随机种子
	private $codeStr='23456789abcdefghjkmnpqrstuvwsyzABCDEFGHJKMNPQRSTUVWSYZ';
	//验证码长度
	private $codeLen=4;
	//验证码字体
	private $font;
	...
	//创建验证码
	public function make($code='code')
	{
		...
		cache([ $code.'_captcha' => $_SESSION['code']],10);
		//var_dump(cache($code).'~'.$_SESSION['code'].'~'.$code);die;
